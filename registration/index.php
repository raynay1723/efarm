...
<body>
    <div class="page-header">
        <h1>Hi, <b><?php echo htmlspecialchars($_SESSION["username"]); ?></b>. Welcome to e-Farm.</h1>
    </div>
       <!DOCTYPE html>
<html>
<header>
    ...
    <div class="container-fluid display-table">
        <div class="row display-table-row">
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                ...
                <div class="navi">
                    <ul>
                        <li class="active"><a href="orders.php"><i class="fa fa-home" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Orders</span></a></li>
                        ...
                        <li><a href="index.php?logout='1"><i class="fa fa-user" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Logout</span></a></li>
